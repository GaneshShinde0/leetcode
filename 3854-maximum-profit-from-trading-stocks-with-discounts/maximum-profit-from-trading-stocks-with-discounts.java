class Solution {
    public int maxProfit(int n, int[] present, int[] future, int[][] hierarchy, int budget) {
        ...
        // Answer at any budget will be dependent on old budgets, so budget is one parameter of dp.
    ...
    private void dfs(int u, int[] present, int[] future, List<Integer>[] tree, int[][][] dp, int budget){
