class Robot{
    ...
    Map<Integer,String> edgeToDirs;
    List<Integer> dir;
    List<int[]> pos;
    public Robot(int width, int height){
        this.edgeToDirs = new HashMap<>();
        this.dir = new ArrayList<>();
        this.pos = new ArrayList<>();

        edgeToDirs.put(0,"East");
        edgeToDirs.put(1,"North");
        edgeToDirs.put(2,"West");
        edgeToDirs.put(3,"South");
    ...
    public String getDir(){
        ...
        return edgeToDirs.get(dir.get(idx));
    }
}
