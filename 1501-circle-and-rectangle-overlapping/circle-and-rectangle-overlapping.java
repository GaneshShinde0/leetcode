class Solution {
    public boolean checkOverlap(int radius, int xCenter, int yCenter, int x1, int y1, int x2, int y2) {
        ...
        return dist(closestX, closestY, xCenter, yCenter) <=radius; //Kind of like pythagoras Theoresm
    }

    public boolean checkOverlapByCountingDistance(int radius, int xCenter, int yCenter, int x1, int y1, int x2, int y2) {
        double dist = 0;
        ...
        return dist<=radius*radius; //Kind of like pythagoras Theoresm
    }
